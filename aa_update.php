...
<div class="container-fluid">
    <div class="col-12 mt-5 text-dark text-monospace text-center">
      <h1 class="h1">Update gastro type</h1>
    </div>
    ...
    <!-- sign in section -->
        ...
        <section class="row alumni d-flex justify-content-around m-1">
              ...
              <div class="col-xl-4 p-xl-4 col-lg-4 p-lg-4 col-md-4 p-md-4 col-sm-4 p-sm-4 col-xs-12 p-xs-12 col-12 p-2 m-2 bg-white shadow-lg rounded-lg">
                    <form method="post"  action="actions/aa_update.php" autocomplete= "off">
                          <div class="form-group row">
                              <label for="gastroTypeId" class="col-sm-2 col-form-label col-form-label-sm">Id</label>
                              <label for="gastroTypeId" class="col-sm-2 col-form-label col-form-label-sm"><?php echo $data['gastroTypeId'] ?></label>
                          </div>
                          <div class="form-group row">
                              <label for="gastroType" class="col-sm-2 col-form-label col-form-label-sm">Gastrotype</label>
                              <div class="col-sm-10">
                                <input type="text" name="gastroType" class="form-control form-control-sm" id="gastroType" placeholder="" value="<?php echo $data['gastroType'] ?>" />
                              </div>
                          </div>
                          <div class="row m-2">
